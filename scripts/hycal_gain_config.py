#!/usr/bin/env python3
"""
HyCal ADC Gain Config Generator
===============================
...
Usage
-----
    python hycal_gain_config.py
    python hycal_gain_config.py -c database/calibration/adc_to_mev_factors_cosmic.json
    python hycal_gain_config.py --pbwo4-gain 0.15 --pbglass-gain 0.12
    python hycal_gain_config.py -o /path/to/adchycal_gain.cnf
"""
...
def generate_config(daq: List[Tuple[str, int, int, int]],
    ...
    lines.append("# Generated by hycal_gain_config.py")
